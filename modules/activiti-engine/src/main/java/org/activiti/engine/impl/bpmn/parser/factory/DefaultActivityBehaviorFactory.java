...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
    ...
    // Custom REST Publish Task
    public RestPublishTaskActivityBehavior createRestPublishTaskActivityBehavior(ServiceTask serviceTask, TaskDefinition taskDefinition) {
        return new RestPublishTaskActivityBehavior(serviceTask, taskDefinition);
    }
